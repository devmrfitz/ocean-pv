...
class TestUsersPostMethod:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ('users:login', {}, {}, 'This field is required', 2),
            ('users:register', {}, {}, 'This field is required', 6),
            ('users:password-reset', {}, {}, 'This field is required', 1),
        ]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ('users:profile-update',
             {'username': 'testuser'}, {}, 'This field is required', 8),
            ('users:password-change', {}, {}, 'This field is required', 3),
        ]
    )
    def test_users_empty_data_registered(
        ...
        """ Test clients are registered here and should be able to post data in these views. The data is empty here and there should be <num_expected> instances of <expected_response> in the response content """
...
# TODO: Fix all tests underneath
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('users:register', {}, {'password2': 'testpassword'},
             'This field is required', 5),
            ('users:register', {}, {'username': 'testuser',
                                    'first_name': 'testfn'}, 'This field is required', 4),
            ('users:register', {}, {'username': 'testuser',
                                    'last_name': 'testln'}, 'This field is required', 4),
            ('users:register', {}, {'username': 'testuser',
                                    'email': 'test@email.com'}, 'This field is required', 4),
            ('users:register', {}, {'username': 'testuser',
                                    'password1': 'testpassword'}, 'This field is required', 4),
            ('users:register', {}, {'username': 'testuser',
                                    'password2': 'testpassword'}, 'This field is required', 4),
            ('users:register', {}, {'first_name': 'testfn',
                                    'last_name': 'testln'}, 'This field is required', 4),
            ('users:register', {}, {'first_name': 'testfn',
                                    'email': 'test@email.com'}, 'This field is required', 4),
            ...
            ('users:register', {}, {'password1': 'testpassword',
                                    'password2': 'testpassword'}, 'This field is required', 4),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'last_name': 'testln'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'email': 'test@email.com'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'password1': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'last_name': 'testln',
                                    'email': 'test@email.com'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'last_name': 'testln',
                                    'password1': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'last_name': 'testln',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'email': 'test@email.com',
                                    'password1': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'email': 'test@email.com',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'password1': 'testpassword',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'first_name': 'testfn', 'last_name': 'testln',
                                    'email': 'test@email.com'}, 'This field is required', 3),
            ('users:register', {}, {'first_name': 'testfn', 'last_name': 'testln',
                                    'password1': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'first_name': 'testfn', 'last_name': 'testln',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'first_name': 'testfn', 'email': 'test@email.com',
                                    'password1': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'first_name': 'testfn', 'email': 'test@email.com',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'last_name': 'testln', 'email': 'test@email.com',
                                    'password1': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'last_name': 'testln', 'email': 'test@email.com',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'email': 'test@email.com', 'password1': 'testpassword',
                                    'password2': 'testpassword'}, 'This field is required', 3),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'last_name': 'testln', 'email': 'test@email.com'}, 'This field is required', 2),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'last_name': 'testln', 'password1': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'last_name': 'testln', 'password2': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'first_name': 'testfn', 'last_name': 'testln',
                                    'email': 'test@email.com', 'password1': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'first_name': 'testfn', 'last_name': 'testln',
                                    'email': 'test@email.com', 'password2': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'username': 'testuser', 'email': 'test@email.com',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'last_name': 'testln', 'email': 'test@email.com',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'username': 'testuser', 'last_name': 'testln',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn',
                                    'email': 'test@email.com', 'password2': 'testpassword'}, 'This field is required', 2),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn', 'last_name': 'testln',
                                    'email': 'test@email.com', 'password1': 'testpassword'}, 'This field is required', 1),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn', 'last_name': 'testln',
                                    'email': 'test@email.com', 'password2': 'testpassword'}, 'This field is required', 1),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn', 'last_name': 'testln',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 1),
            ('users:register', {}, {'username': 'testuser', 'first_name': 'testfn', 'email': 'test@email.com',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 1),
            ('users:register', {}, {'username': 'testuser', 'last_name': 'testln', 'email': 'test@email.com',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 1),
            ('users:register', {}, {'first_name': 'testfn', 'last_name': 'testln', 'email': 'test@email.com',
                                    'password1': 'testpassword', 'password2': 'testpassword'}, 'This field is required', 1),
        ]
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ('users:profile-update', {'username': 'testuser'},
             {'first_name': 'testfn'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'last_name': 'testln'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'email': 'test@email.com'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'user_bio': 'test-bio'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'country': 'Enter'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'gender': 'male'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'birth_date': '11/11/2001'}, 'This field is required', 7),
            ('users:profile-update', {'username': 'testuser'},
             {'visible': 'False'}, 'This field is required', 7),
    ...
    def test_users_partial_data_registered(
        ...
        """ Test clients are registered here and they should be able to post data in these views. The data is partially complete here and there should be <num_expected> instances of <expected_response> in the response content """
...
class TestInteractionsPostMethodValid:
    """ The data submitted here should be completely valid. Tests should not be parameterized here, unless they really need to be. """
    ...
    def test_home_contact_email(
        ...
        """ Test clients are unregistered here but should be able to post data in these views. The data is complete and valid here and the data sent through form should be present in the mail inbox """

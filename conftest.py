...
def create_user(test_username, test_password, django_user_model):
    """ Creates a test user to simulate a registered client. """
...
def login_user(create_user, test_password, client):
    """ Logs in a user with their correct password and returns client and user. """
...
@pytest.fixture()
def return_views():
    """ Returns the view using reverse_url and corresponding kwargs (if any). """
